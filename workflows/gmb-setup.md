...
| Client trade is garage door repair, locksmith, landscaping/lawn care, or general contracting/remodeling | Higher suspension risk — an AI-driven "Deceptive Content" enforcement wave (started April 27, 2026) disproportionately hit these exact verticals. Google's routine GBP edit review is also now Gemini-moderated (since April 16, 2026). Verify real business documentation before setup, use only real (non-stock, non-AI-generated) photos, and avoid exaggerated claims in the profile description. |
