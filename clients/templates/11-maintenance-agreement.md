...
| | Basic | Standard | Pro |
|---|---|---|---|
| Monthly fee | $99/mo | $199/mo | $299/mo |
| Broken link check | ✅ | ✅ | ✅ |
| Speed check (CWV) | ✅ | ✅ | ✅ |
| 1 minor content update | ✅ | ✅ | ✅ |
| Status email | ✅ | ✅ | ✅ |
| Security headers check | | ✅ | ✅ |
| Monthly performance report | | ✅ | ✅ |
| Up to 2 hrs content/design updates | | ✅ | ✅ |
| Full technical SEO re-audit | | | ✅ |
| GBP post draft (monthly) | | | ✅ |
| Blog post or page update | | | ✅ |

**Selected plan:** [ ] Basic — $99/mo &nbsp;&nbsp; [ ] Standard — $199/mo &nbsp;&nbsp; [ ] Pro — $299/mo
...
4. Send a status email summarizing what was done and flagging anything that needs your attention
5. Deliver a monthly performance report (Standard and Pro plans only)

Work is completed in the first 5 business days of each calendar month.

---

## What's Not Included

The following are **not** covered by this agreement and will be quoted separately:

- Building new pages or major redesigns
- Adding new features or functionality (e-commerce, booking systems, etc.)
- Responding to hacking or malware attacks caused by client-installed third-party plugins
- Purchasing or renewing hosting, domain names, or third-party tools
- Social media management or paid advertising
- Any work outside the included hours (Standard/Pro) — additional time billed at $75/hr
- Emergency support outside of the monthly maintenance cycle — quoted per incident
...
- **Payment method:** [Bank transfer / PayPal / other — to be confirmed]
- **Payment due:** Within 7 days of invoice date
- **Late payment:** Work for that month is paused until payment is received. No penalty fee on first occurrence.
...
By signing below, both parties agree to the terms of this Maintenance & Care Agreement.
