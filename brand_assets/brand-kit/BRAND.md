...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#B87333` | Gradient start, CTA, accents |
| Secondary | `#4E9F7D` | Gradient end, hover states |
| Text (light bg) | `#FAFAF7` | Body text on white/light |
| Text (dark bg) | `#1C1917` | Body text on dark |
| Background (light) | `#FAFAF7` | Light mode |
| Background (dark) | `#1C1917` | Dark mode |
